    ...
    >
      ...
      <div className="z-10 flex flex-col items-center justify-center w-full transform-style-3d perspective-1000">
        ...
        <div className="hud-element mb-12 flex items-center gap-4">
          ...
          <div className="px-4 py-1.5 border border-cyan-500/30 bg-cyan-500/10 backdrop-blur-md rounded-sm">
        ...
        >
          ...
          <h1 className="hero-text text-[12vw] md:text-[140px] font-black leading-[0.85] tracking-tighter uppercase relative select-none">
            ...
            >
              ...
              <span className="absolute inset-0 text-transparent bg-clip-text bg-gradient-to-b from-transparent to-slate-900 drop-shadow-none translate-y-2 -z-10 mix-blend-overlay">SHARIKA</span>
            </span>
          </h1>
      ...
      {/* Side HUD Elements */}
      <div className="hud-element absolute left-8 top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-8 opacity-40">
        {[...Array(5)].map((_, i) => (
      ...
      <div className="hud-element absolute right-8 top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-end gap-2 opacity-40">
